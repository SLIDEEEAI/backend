...
DEBUG = True if config("DEBUG_MODE") == "True" else False
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'presentation.authentication.JWTAuthentication'
    ],
...
FRONTEND_URL = "https://sivka.online"
